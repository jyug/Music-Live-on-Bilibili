    ...
    # else:
        # try:
            # if(os.path.isfile(path+'/resource/playlist/'+str(filename)+'.mp4')):    #获取视频文件信息
                # print(path+'/resource/playlist/'+str(filename)+'.mp4')
                # vv = VideoFileClip(path+'/resource/playlist/'+str(filename)+'.mp4')
            ...
            # elif(os.path.isfile(path+'/resource/playlist/'+str(filename)+'rendering1.flv')):
                # print(path+'/resource/playlist/'+str(filename)+'rendering1.flv')
                # vv = VideoFileClip(path+'/resource/playlist/'+str(filename)+'rendering1.flv')
                # seconds=int(vv.duration)   #获取时长
                # print('time seconds:'+str(seconds))
                # for i in range(1, seconds):
                    # result+='Dialogue: 2,'+s3t(i-1)+'.00,'+s3t(i)+'.00,right_down,,0,0,0,,视频时间:'+s3t(i)+'/'+s3t(seconds)+'\r\n'
            # elif(os.path.isfile(path+'/resource/playlist/'+str(filename)+'rendering1.mp4')):
                # print(path+'/resource/playlist/'+str(filename)+'rendering1.mp4')
                # vv = VideoFileClip(path+'/resource/playlist/'+str(filename)+'rendering1.mp4')
                # seconds=int(vv.duration)   #获取时长
                # print('time seconds:'+str(seconds))
                # for i in range(1, seconds):
                    # result+='Dialogue: 2,'+s3t(i-1)+'.00,'+s3t(i)+'.00,right_down,,0,0,0,,视频时间:'+s3t(i)+'/'+s3t(seconds)+'\r\n'
            # else:
                ...
                # print(path+'/resource/playlist/'+str(filename))
        # except Exception as e:
            # print('shit')
            # print(e)
    return result
